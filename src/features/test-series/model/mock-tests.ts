...
export const mockGroups: TestGroup[] = [
  {
    id: 'ssc',
    title: 'SSC Exams',
    description: 'Access complete Tier-1 & Tier-2 Previous Year Question Papers (Shift-wise PDFs).',
    status: 'active',
    count: '45+ Shift Papers',
  },
  {
    id: 'banking',
    title: 'Banking Exams',
  ...
  },
  {
    ...
    description: 'Mock tests and previous papers for CTET, UPTET, and KVS.',
    status: 'pending',
    badge: 'Coming Soon',
    count: 'Coming Soon',
  },
  {
    id: 'defense',
    title: 'Defense Exams',
    description: 'Comprehensive preparation for NDA, CDS, and AFCAT.',
    status: 'pending',
    badge: 'Coming Soon',
    count: 'Coming Soon',
  },
  {
    id: 'railways',
    title: 'Railway Exams',
    description: 'Practice series for RRB NTPC, Group D, and ALP.',
    status: 'pending',
    badge: 'Coming Soon',
    count: 'Coming Soon',
  },
  {
    ...
    description: 'Test series for SSC JE, GATE, and State AE/JE exams.',
    status: 'pending',
    badge: 'Coming Soon',
    count: 'Coming Soon',
  },
  {
    id: 'state',
    title: 'State Exams',
    description: 'Specialized state PSC and police recruitment mock papers.',
    status: 'pending',
    badge: 'Coming Soon',
    count: 'Coming Soon',
  },
